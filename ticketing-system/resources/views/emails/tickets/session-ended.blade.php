                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                        ...
                                        <h1 style="color: #172A91; font-size: 24px; margin: 0 0 30px 0;">Session Complete!</h1>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8fafc; border-radius: 8px; margin-bottom: 30px;">
                                <tr>
                                    <td style="padding: 25px;">
                                        <p style="margin: 0; color: #4b5563;">You've completed your session at</p>
                                        @if($cafe)
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #172A91; border-radius: 8px; margin: 20px 0; text-align: -webkit-center;">
                                            <tr>
                                                <td style="padding: 15px; color: white; text-align: center;">
                                                    <div style="font-size: 14px;">Session Ended At</div>

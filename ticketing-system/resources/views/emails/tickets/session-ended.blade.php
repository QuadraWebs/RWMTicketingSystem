                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                        ...
                                        <h1 style="color: #2563eb; font-size: 24px; margin: 0 0 30px 0;">Session Complete!</h1>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8fafc; border-radius: 8px; margin-bottom: 30px;">
                                <tr>
                                    <td style="padding: 25px;">
                                        ...
                                        <!-- End Time Box -->
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background: #172A91; border-radius: 8px; margin: 20px 0;">
                                            <tr>
                                        ...
                                        <!-- Thank You Box -->
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #f0f9ff; border: 1px solid #bae6fd; border-radius: 8px; margin: 20px 0;">
                                            <tr>
                                                <td style="padding: 15px; text-align: center; color: #0369a1;">

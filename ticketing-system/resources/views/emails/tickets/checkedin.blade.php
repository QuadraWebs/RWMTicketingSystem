                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                        <div style="background-color: #172A91; color: white; width: 48px; height: 48px; border-radius: 50%; line-height: 48px; text-align: center; font-size: 24px; margin-bottom: 20px;">✓</div>
                                        <h1 style="color: #172A91; font-size: 24px; margin: 0 0 30px 0;">Check-in Successful!</h1>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8fafc; border-radius: 8px; margin-bottom: 30px;">
                                <tr>
                                    <td style="padding: 25px;">
                                        ...
                                        <h2 style="color: #172A91; font-size: 20px; margin: 10px 0;">{{ $cafe->name }}</h2>
                                        
                                        <!-- Session Time -->
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #172A91; border-radius: 8px; margin: 20px 0; text-align: -webkit-center;">
                                            <tr>
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <span style="background-color: #172A91; color: white; width: 24px; height: 24px; border-radius: 50%; display: inline-block; text-align: center; line-height: 24px; margin-right: 10px; font-size: 12px;">1</span>
                                                    Please keep your workspace clean
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <span style="background-color: #172A91; color: white; width: 24px; height: 24px; border-radius: 50%; display: inline-block; text-align: center; line-height: 24px; margin-right: 10px; font-size: 12px;">2</span>
                                                    Respect other coworkers' space
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <span style="background-color: #172A91; color: white; width: 24px; height: 24px; border-radius: 50%; display: inline-block; text-align: center; line-height: 24px; margin-right: 10px; font-size: 12px;">3</span>
                                                    Use headphones for calls/media
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <span style="background-color: #172A91; color: white; width: 24px; height: 24px; border-radius: 50%; display: inline-block; text-align: center; line-height: 24px; margin-right: 10px; font-size: 12px;">4</span>
                            ...
                            <!-- Footer -->
                            <table role="presentation" width="100%" style="margin-top:10px" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                                ...
                                                <td align="center" style="padding-top: 15px;">
                                                    <table role="presentation" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="padding: 0 10px;">
                                                                <a href="https://www.facebook.com/share/g/ibBdv366a6jYdJ87/?mibextid=K35XfP" style="color: #000000;">
                                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">

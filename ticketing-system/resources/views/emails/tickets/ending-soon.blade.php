                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                        ...
                                        <h1 style="color: #172A91; font-size: 24px; margin: 0 0 30px 0;">Time's Almost Up!</h1>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8fafc; border-radius: 8px; margin-bottom: 30px;">
                                <tr>
                                    <td style="padding: 25px;">
                                        ...
                                        <p style="margin: 0; color: #4b5563;">Please prepare to wrap up your work session. Thank you for using our workspace!</p>
                                    </td>
                                </tr>
                            </table>

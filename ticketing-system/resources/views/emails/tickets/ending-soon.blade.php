...
<body>
    <div class="card">
        <div class="receipt-header">
            ...
            <h1 class="header">Time's Almost Up!</h1>
        </div>
        
        <div class="ticket-container">
            <div class="welcome-text">Your session is ending soon</div>
            @if($cafe)
            ...
            <div class="validity-box">
                <div class="mt-2">
                    <div class="validity-label">Your Session Ends At</div>
                    <div class="validity-date">{{ $endTime->format('h:i A') }}</div>
                </div>
            </div>
            
            <div class="welcome-text">Please prepare to wrap up your work session. Thank you for using our workspace!</div>
        </div>
